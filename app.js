...
class ScrollAnimations {
    ...
    init() {
        const animatedElements = document.querySelectorAll('.service__card, .feature, .benefit');
...
class PhoneFormatter {
    ...
    init() {
        const phoneNumbers = document.querySelectorAll('.contact__phone');
...
class StatisticsCounter {
    ...
    init() {
        const statsElements = document.querySelectorAll('.stat__number, .highlight__number');
        ...
        statsElements.forEach(element => {
            ...
            if (/^\d+$/.test(originalText)) {
                element.setAttribute('data-count', originalText);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const interactiveElements = document.querySelectorAll('.btn, .service__card, .feature, .benefit');
